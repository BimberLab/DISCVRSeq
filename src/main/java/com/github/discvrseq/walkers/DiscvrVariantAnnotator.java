...
/**
 * Annotate variant calls with context information. This is an extension of GATK's VariantAnnotator, and adds a number of custom optional annotations.
 * By default it should return the exact same about as GATK's tool.
 *
 * <h3>Input</h3>
 * <p>
...
public class DiscvrVariantAnnotator extends VariantAnnotator {
    ...
    public Collection<Annotation> makeVariantAnnotations() {
        Set<Annotation> ret = new HashSet<>(super.makeVariantAnnotations());

        GATKAnnotationPluginDescriptor annotationPlugin = getCommandLineParser().getPluginDescriptor(GATKAnnotationPluginDescriptor.class);
